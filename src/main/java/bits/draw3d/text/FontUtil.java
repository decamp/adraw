...
//        return charsWidth( font, chars, off, len );
//    }
//
//
//    public static float charsWidth( Paint.FontMetrics metrics, CharSequence seq ) {
//        return charsWidth( metrics, seq, 0, seq.length() );
//    }
//
//
//    public static float charsWidth( Paint paint, CharSequence seq, int off, int len ) {
//        int ret = 0;
//        for( int i = 0; i < len; i++ ) {
//            ret += paint.getTextWidthWcharWidth( seq.charAt( i + off ) );
//        }
//        return ret;
//
//        /*
...
//
//
//    public static float charsWidth( Paint.FontMetrics metrics, char[] chars, int off, int len ) {
//        int ret = 0;
//        for( int i = 0; i < len; i++ ) {
...
//     */
//    public static int findWidth( Paint.FontMetrics metrics,
//                                 char[] chars,
//                                 int off,
//                                 int len,
//                                 float maxWidth,
