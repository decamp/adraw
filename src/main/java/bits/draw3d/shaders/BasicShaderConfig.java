...
public class BasicShaderConfig {
    ...
    public void chooseAvailable( BasicShaderConfig out ) {
        ...
        case GL_LINE_STRIP:
        case GL_LINE_LOOP:
        case Fake.GL_LINES_ADJACENCY:
        case Fake.GL_LINE_STRIP_ADJACENCY:
            if( mLineWidth != 1f ) {
                out.mColor      = true;
                out.mNorm       = false;
                out.mTexCompNum = 0;
        ...
        case Fake.GL_TRIANGLES_ADJACENCY:
        case Fake.GL_TRIANGLE_STRIP_ADJACENCY:
        case Fake.GL_QUADS:
        {
            if( mTexCompNum == 0 ) {
                out.mNorm = false;
